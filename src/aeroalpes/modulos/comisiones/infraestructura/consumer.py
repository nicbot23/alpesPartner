...
from aeroalpes.seedwork.aplicacion.mediador import publicar_evento
from aeroalpes.modulos.comisiones.aplicacion import handlers as _handlers  # ensure decorators loaded
