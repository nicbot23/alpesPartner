...
from aeroalpes.modulos.comisiones.dominio.repositorios.repositorios import RepositorioComisiones
from aeroalpes.modulos.comisiones.dominio.agregados import Comision
from aeroalpes.modulos.comisiones.infraestructura.mapeadores.mapeadores import a_modelo, a_outbox
...
class RepoComisionesSQLAlchemy(RepositorioComisiones):
    ...
    def crear_desde_datos(self, conversion_id, affiliate_id, campaign_id, bruto, currency)->str:
        pct=self._pct()
        from aeroalpes.modulos.comisiones.dominio.fabricas.fabricas import FabricaComisiones
